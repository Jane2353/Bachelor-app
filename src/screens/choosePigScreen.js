    ...
    <View style={styles.container}>
      <View style={styles.content}>
        <Text style={styles.title}>
          ...
          <Image
            source={require("../../assets/Pig/front_happy_transparent.png")}
            style={styles.icon}
          />
        </Text>
        <Text style={styles.description}>
          Complete challenges that help manage your finances. By keeping up with
          your challenges, you can ensure your pig stays happy. Watch your hard
          work pay off, as you watch your pig grow up!
        </Text>
